...
class OctreeNode {
    ...
    branch(indexOctant) {
        ...
        if (this.nodesByIndex[indexOctant] instanceof OctreeNode) {
            ...
            const offset = new Vector3(indexOctant & 1 ? radiusOffset : -radiusOffset, indexOctant & 2 ? radiusOffset : -radiusOffset, indexOctant & 4 ? radiusOffset : -radiusOffset);
    ...
    expand(objects, octants) {
        ...
        if (this.tree.root.getDepthEnd() < this.tree.depthMax) {
            ...
            if (objectsExpand.length > 0) {
                ...
                const position = new Vector3(indexOctant & 1 ? radiusOffset : -radiusOffset, indexOctant & 2 ? radiusOffset : -radiusOffset, indexOctant & 4 ? radiusOffset : -radiusOffset);
 ...
 */
class OctreeRaycaster extends Raycaster {
    /**
