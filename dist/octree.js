define("OctreeObjectData", ["require", "exports", "three"], function (require, exports, three_1) {
    "use strict";
...
define("OctreeNode", ["require", "exports", "OctreeObjectData", "Octree", "three"], function (require, exports, OctreeObjectData_1, Octree_1, three_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var OctreeNode = /** @class */ (function () {
        function OctreeNode(parameters) {
            ...
            this.position = parameters.position instanceof three_2.Vector3 ? parameters.position : new three_2.Vector3();
            ...
            // visual
            if (this.tree.scene) {
                this.visual = new three_2.Mesh(this.tree.visualGeometry, this.tree.visualMaterial);
        ...
        OctreeNode.prototype.branch = function (indexOctant) {
            ...
            if (this.nodesByIndex[indexOctant] instanceof OctreeNode) {
                ...
                var offset = new three_2.Vector3(indexOctant & 1 ? radiusOffset : -radiusOffset, indexOctant & 2 ? radiusOffset : -radiusOffset, indexOctant & 4 ? radiusOffset : -radiusOffset);
        ...
        OctreeNode.prototype.expand = function (objects, octants) {
            ...
            if (this.tree.root.getDepthEnd() < this.tree.depthMax) {
                ...
                if (objectsExpand.length > 0) {
                    ...
                    var position = new three_2.Vector3(indexOctant & 1 ? radiusOffset : -radiusOffset, indexOctant & 2 ? radiusOffset : -radiusOffset, indexOctant & 4 ? radiusOffset : -radiusOffset);
        ...
        OctreeNode.prototype.intersectRay = function (origin, direction, distance, directionPct) {
            if (typeof directionPct === 'undefined') {
                directionPct = new three_2.Vector3(1, 1, 1).divide(direction);
            }
...
define("Octree", ["require", "exports", "three", "OctreeNode", "utils", "OctreeObjectData"], function (require, exports, three_3, OctreeNode_1, utils_1, OctreeObjectData_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Octree = /** @class */ (function () {
        function Octree(parameters) {
            ...
            this.utilVec31Search = new three_3.Vector3();
            this.utilVec32Search = new three_3.Vector3();
            this.objects = [];
            this.objectsMap = {};
            this.objectsData = [];
            ...
            if (this.scene) {
                this.visualGeometry = new three_3.BoxBufferGeometry(1, 1, 1);
                this.visualMaterial = new three_3.MeshBasicMaterial({
                    color: 0xff0066,
                    wireframe: true,
        ...
        Octree.prototype.addDeferred = function (object, options) {
            ...
            if (object instanceof OctreeObjectData_2.OctreeObjectData) {
                object = object.object;
            }
            // check uuid to avoid duplicates
            if (!object.uuid) {
                object.uuid = three_3.Math.generateUUID();
            }
            if (!this.objectsMap[object.uuid]) {
                ...
                if (useVertices === true) {
                    ...
                    if (object.geometry instanceof three_3.BufferGeometry && object.geometry.attributes.position instanceof three_3.BufferAttribute) {
                        var position = object.geometry.attributes.position;
                        for (var i = 0, l = position.count; i < l; i++) {
                            this.addObjectData(object, new three_3.Vector3().fromBufferAttribute(position, i));
                        }
                    }
                    else if (object.geometry instanceof three_3.Geometry) {
                        var vertices = object.geometry.vertices;
                    ...
                    if (object.geometry instanceof three_3.BufferGeometry) {
                        var position = object.geometry.attributes.position;
                        ...
                        if (index) {
                            ...
                            for (var i = 0, l = index.count; i < l; i += 3) {
                                this.addObjectData(object, new three_3.Face3(i, i + 1, i + 2));
                            }
                        }
                        else {
        ...
        Octree.prototype.addObjectData = function (object, part) {
            var objectData = new OctreeObjectData_2.OctreeObjectData(object, part);
        ...
        Octree.prototype.search = function (position, radius, organizeByObject, direction) {
            ...
            if (direction instanceof three_3.Vector3) {
                direction = direction.clone().normalize();
                directionPct = new three_3.Vector3(1, 1, 1).divide(direction);
            }
...
define("index", ["require", "exports", "Octree"], function (require, exports, Octree_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Octree = Octree_2.Octree;
});
